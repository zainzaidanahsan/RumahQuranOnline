package com.zain.rumahquranonline.constan
...
class MyApplication:Application() {
    ...
    companion object{
        ...
        fun loadPdfSize(pdfUrl:String, pdfTitle : String, txt_size: TextView){
            ...
            ref.metadata
                .addOnSuccessListener { storageMetadata->
                    ...
                    val mb = kb/1024
                    if(mb>1){
                        txt_size.text = "${String.format("%.2f",mb)} MB"
                    }
                    else if (kb>1){
                        txt_size.text = "${String.format("%.2f",kb)} KB"
                    }
                    else{
                        txt_size.text = "${String.format("%.2f",bytes)} bytes"
                    }
                }
                .addOnFailureListener {e->
                    Log.d(TAG, "loadPdfSize: Gagal menampilkan pdf karena  ${e.message}")
                }
        ...
        fun loadPdfFromUrlSinglePage(
            ...
            val ref = FirebaseStorage.getInstance().getReferenceFromUrl(pdfUrl)
            ref.getBytes(const.MAX_BYTES_PDF)
                ...
                .addOnSuccessListener {
                    ...
                    ref.child(bookId)
                        ...
                        .addOnSuccessListener {
                            ...
                            Log.d(TAG, "deleteBook: berhasil menghapus pada db")
                        }
                        .addOnFailureListener {e->
                            progressDialog.dismiss()
