...
import com.zain.rumahquranonline.databinding.FragmentListPdfUserBinding


class ListPdfUser : Fragment() {
    private var _binding : FragmentListPdfUserBinding?= null
    private val binding get() = _binding!!

    private var categoryId = ""
    private var category = ""
    private lateinit var pdfArrayList:ArrayList<DataPdf>
    private lateinit var adapter: ListPdfUserAdapter
    ...
    override fun onCreateView(
        ...
        _binding =  FragmentListPdfUserBinding.inflate(layoutInflater,container, false)
        return binding.root
    }
        ...
        ref.orderByChild("categoryID").equalTo(categoryId)
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    if(isAdded){
                        adapter = ListPdfUserAdapter(requireContext(),pdfArrayList)
