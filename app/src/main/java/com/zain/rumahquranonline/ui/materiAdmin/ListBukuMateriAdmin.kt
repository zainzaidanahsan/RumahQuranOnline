...
import com.zain.rumahquranonline.databinding.FragmentListBukuMateriAdminBinding


class ListBukuMateriAdmin : Fragment() {

    private var _binding :FragmentListBukuMateriAdminBinding?= null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentListBukuMateriAdminBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
        ...
        ref.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (isAdded){
                    ...
                    adapter = CategoryAdapter(requireContext(), categoryArrayList)
